...
Simulation begins at z_0_idx of zgrid.
"""
function simulateProd(P_z, zgrid, T; N = 10000, z_0_idx = median(1:length(zgrid)), seed = 211, set_seed = true)
    ...
    zt[:,1] .= floor(Int64, z_0_idx)  # Set z_0 with valid index
